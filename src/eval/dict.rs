...
/// A dictionary data structure, which maps from integers (`u64`) or strings to a generic
/// value type.
///
/// The data structure can model arrays by assigns values to successive indices from
/// `0..n`. The type offers special support for this pattern by exposing a `push` method.
#[derive(Clone)]
pub struct Dict<V> {
    nums: BTreeMap<u64, V>,
...
/// An dictionary entry which tracks key and value span.
